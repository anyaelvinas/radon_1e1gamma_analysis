...
cut_simulation = "/sps/nemo/scratch/elvin/cut_simulations/cut_Bi214_wire_surface_50M.root"
original_alias = "Bi214_wire_surface_50M.root"
cut_macro = "/sps/nemo/scratch/elvin/macros/cuts_V1.C"
output_csv = "/sps/nemo/scratch/elvin/csvs/simulation_summary.csv"
...
def calculate_efficiency_parameters():
    ...
    original_file = uproot.open(original_simulation) # before
    original_tree = original_file["Result_tree"]
    n_original_events = original_tree.num_entries
    ...
    eff_uncertainty = (efficiency * (1 - efficiency) / n_original_events) ** 0.5 # σϵ​ = ( ϵ(1-ϵ)/Ntot )**0.5 # CHECK THIS
